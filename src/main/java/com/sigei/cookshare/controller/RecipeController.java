...
import com.sigei.cookshare.service.recipe.IRecipeService;
...
public class RecipeController {
    ...
    public ResponseEntity<RecipeDto> updateRecipe(@PathVariable Long recipeId, @RequestBody RecipeUpdateRequest request) {
        Recipe updateRecipe = recipeService.updateRecipe(request, recipeId);
        RecipeDto recipeDto = recipeService.convertToDto(updateRecipe);
        return ResponseEntity.ok(recipeDto);
    }
